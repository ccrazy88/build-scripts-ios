...
# set_build_number.sh
#
# Sets the build number of the current target to the number of commits in the
# current Git branch. If we're using the Debug build configuration, suffix the
# build number with the current branch name to make collisions far less likely
